...
[![hexlet-check](https://github.com/Rave-station/php-project-45/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Rave-station/php-project-45/actions)
...
```bash
git clone https://github.com/Rave-station/php-project-45.git
cd php-project-45
```
...
https://asciinema.org/a/RGZvtxIFA9NnV4u8
